				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<ul class="contact-details">
							<li><i class="fa fa-envelope"></i>careerguidance@tkietwarna.ac.in</li>
							<li><i class="fa fa-phone"></i>8208435520</li>
							<li><i class="fa fa-map-marker"></i>Warnanagar, Kolhapur</li>
						</ul>
